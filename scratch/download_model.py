...
def main():
    ...
    print("3. Qwen/Qwen3-VL-2B-Instruct (4.5 GB) - Default recommended VLM")
    print("4. Qwen/Qwen2-VL-2B-Instruct (4.5 GB) - Alternate VLM")
    print("5. HuggingFaceTB/SmolVLM-256M-Instruct (0.8 GB) - Ultra-light VLM")
    print("6. Download All (All of the above)")
    print("7. Exit")
